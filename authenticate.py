...
parser.add_argument('--gallery', dest='gallery', help='Gallery image')
parser.add_argument('--probe1', dest='probe1', help='First probe image')
...
face_authenticate = FaceAuthenticate(host=args.host, key_file=args.key_file, verbose=args.verbose)
